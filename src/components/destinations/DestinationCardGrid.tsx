...
import type { DestinationGuideCard } from '@/lib/v3DestinationIntelligence';

export default function DestinationCardGrid({ title, eyebrow, cards }: { title: string; eyebrow: string; cards: DestinationGuideCard[] }) {
  return (
