...
import type { AuthorityLink } from '@/lib/knowledgeGraphAuthority';

export default function AuthorityLinkGrid({
  title,
  eyebrow,
  links,
}: {
      ...
      <div className="mt-5 grid gap-3 md:grid-cols-3">
        {links.map((link) => (
          ...
          >
            ...
            <span className="mt-3 inline-flex items-center gap-2 text-sm font-bold text-brand-600">
